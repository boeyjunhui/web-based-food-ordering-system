       ...
       <div id="layoutSidenav">
        ...
        <main>
            <div class="container-fluid">
                ...
                <h1 class="mt-4 mb-4 ml-1">Manage Food Menu</h1>
                
                <div class="row col-md-6">
                    <input class="mb-4 ml-1 col-md-7 form-control" id="search" type="search" name="search_food_menu" placeholder="Search Name, Description, Price, Category">
                </div>
                    ...
                    <table class="table table-hover text-center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form action="update_food_menu.php" method="POST">
                                        <input type="hidden" name="edit_menu" value="<?php echo $row['MenuID']; ?>">
                                        <button class="btn btn-primary" type="submit" name="edit_btn">Edit</button>
                                    </form>
                                </td>
                                <td>
                                    <form action="process.php" method="POST">
                                        <input type="hidden" name="delete_menu" value="<?php echo $row['MenuID']; ?>">
                                        <button class="btn btn-danger" onClick="return confirm('Are you sure to delete food menu?');" name="delete_menu_btn">Delete</button>
                                    </form>
                                </td>
                            </tr>
                            <?php
                                    ...
                                    echo '<p class="ml-3">'."No food menu record is found.".'</p>';
                                }
