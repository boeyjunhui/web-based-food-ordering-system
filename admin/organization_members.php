       ...
       <div id="layoutSidenav">
        ...
        <main>
            <div class="container-fluid">
                ...
                <h1 class="mt-4 mb-4 ml-1">Organization Members</h1>

                <div class="row col-md-6">
                    <input class="mb-4 ml-1 col-md-6 form-control" id="search" type="search" name="search_member" placeholder="Search Name, Email, Role">
                </div>
                ...
                <div class="row table-responsive">
                    <table class="table table-hover text-center">
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM Organization_Member";
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="update_member.php" method="POST">
                                        <input type="hidden" name="edit_member" value="<?php echo $row['MemberID']; ?>">
                                        <button class="btn btn-primary" type="submit" name="edit_btn">Edit</button> 
                                    </form>
                                </td>
                                <td>
                                    <form action="process.php" method="POST">
                                        <input type="hidden" name="delete_member" value="<?php echo $row['MemberID']; ?>">
                                        <button class="btn btn-danger" onClick="return confirm('Are you sure to delete member account?');" type="submit" name="delete_member_btn">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        <?php
                                ...
                                echo '<p class="ml-3">'."No member record is found.".'</p>';
                            }
