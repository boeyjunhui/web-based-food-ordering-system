       ...
       <div id="layoutSidenav">
        ...
        <main>
            <div class="container-fluid">
                ...
                <h1 class="mt-4 mb-4 ml-5">Update Food Menu</h1>
                ...
                <form action="process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="mb-4 ml-5 col-md-4">
                            ...
                            <div><input class="col-md-9 col-form-label" type="text" name="name" value="<?php echo $row['Name']; ?>" placeholder="Enter food name" pattern="[A-Za-z -]+" minlength="1" maxlength="50" required></div>
                        </div>
                        <div class="mb-4 ml-5 col-md-4">
                            <label for="description">Description *</label>
                            <div><input class="col-md-9 col-form-label" type="text" name="description" value="<?php echo $row['Description']; ?>" placeholder="Enter food description" pattern="[A-Za-z0-9 ,-]+" required></div>
                        </div>
                    </div>   
                    ...
                    <div class="row">
                        <div class="mb-4 ml-5 col-md-4">
                            ...
                            <div><input class="col-md-9 col-form-label" type="number" name="price" value="<?php echo $row['Price']; ?>" step="0.01" placeholder="Enter food price" min="1" max="100" required></div>
                        </div>
                        <div class="mb-4 ml-5 col-md-4">
                            ...
                            <div>
                                <select class="col-md-4 col-form-label" name="category" required>
                                    ...
                                    <?php
                                        ...
                                        echo "<option value='Pastas'>Pastas</option>";
                                    ...
                                    } elseif ($row['Category'] == 'Pastas') {
                                        echo "<option value='Pizza'>Pizza</option>";
                                        echo "<option value='Pastas' selected>Pastas</option>";
                                        echo "<option value='Salads'>Salads</option>";
                                        echo "<option value='Desserts'>Desserts</option>";    
                                        echo "<option value='Beverages'>Beverages</option>";
                                    } elseif ($row['Category'] == 'Salads') {
                                        echo "<option value='Pizza'>Pizza</option>";
                                        echo "<option value='Pastas'>Pastas</option>";
                                        ...
                                        echo "<option value='Pastas'>Pastas</option>";
                                        echo "<option value='Salads'>Salads</option>";
                                        echo "<option value='Desserts' selected>Desserts</option>";    
                                        echo "<option value='Beverages'>Beverages</option>";
                                    } else {
                                        echo "<option value='Pizza'>Pizza</option>";
                                        echo "<option value='Pastas'>Pastas</option>";
                                        echo "<option value='Salads'>Salads</option>";
                                        echo "<option value='Desserts'>Desserts</option>";    
                                        echo "<option value='Beverages' selected>Beverages</option>";
                                    }
                                    ?> 
                                </select>
                            </div>
                ...
                ?>
                    ...
                    <div class="row">
                        <div class="mt-5 ml-5 col-md-4">
                            <a href="manage_food_menu.php" class="btn btn-danger">Cancel</a>
                            <input class="ml-3 btn btn-primary" type="submit" name="update_menu_btn" value="Update Menu">
                        </div>
                    </div>
                </form>
