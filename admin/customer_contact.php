       ...
       <div id="layoutSidenav">
        ...
        <main>
            <div class="container-fluid">
                ...
                <h1 class="mt-4 mb-4 ml-1">Customer Contact</h1>

                <div class="row col-md-6">
                    <input class="mb-4 ml-1 col-md-6 form-control" id="search" type="search" name="search_customer" placeholder="Search Name, Email, Message">
                </div>
                    ...
                    <table class="table table-hover text-center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form action="process.php" method="POST">
                                        <input type="hidden" name="delete_message" value="<?php echo $row['ContactID']; ?>">
                                        <button class="btn btn-danger" onClick="return confirm('Are you sure to delete this message?');" type="submit" name="delete_message_btn">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        <?php
                                ...
                                echo '<p class="ml-3">'."No customer contact record is found.".'</p>';
                            }
