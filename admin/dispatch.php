       ...
       <div id="layoutSidenav">
        ...
        <main>
            <div class="container-fluid">
                ...
                <h1 class="mt-4 mb-4 ml-1">Order Dispatch</h1>
                ...
                <div class="row table-responsive">
                    <table class="table table-hover text-center">
                        ...
                        <?php
                            ...
                            WHERE New_Order.Status='Accepted'";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form action="process.php" method="POST">
                                        <select class="col-form-label" name="rider" required>
                                            <option value="">Please select...</option>
                                            <?php
                                                $rider_query = "SELECT * FROM Organization_Member WHERE UserRole='Rider'";
                                                $rider_query_run = mysqli_query($connection, $rider_query);

                                                while ($rider_row = mysqli_fetch_assoc($rider_query_run)) {
                                            ?>
                                            <option name="rider_id" value="<?php echo $rider_row['MemberID']; ?>"><?php echo $rider_row['FirstName']." ".$rider_row['LastName']; ?></option>
                                            <?php
                                                    }
                                            ?>
                                        </select>
                                ...
                                <td>
                                    <form action="process.php" method="POST">
                                        ...
                                        <button class="btn btn-primary" type="submit" name="deploy_rider_btn">Deploy</button>
                                    </form>
                                </td>
                                <td>
                            ...
                            <?php
                                    ...
                                    echo '<p class="ml-3">'."No accepted orders.".'</p>';
                                }
