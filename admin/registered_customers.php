       ...
       <div id="layoutSidenav">
        ...
        <main>
            <div class="container-fluid">
                ...
                <h1 class="mt-4 mb-4 ml-1">Registered Customers</h1>

                <div class="row col-md-6">
                    <input class="mb-4 ml-1 col-md-6 form-control" id="search" type="search" name="search_customer" placeholder="Search Name, Email, Contact Number">
                </div>
                    ...
                    <table class="table table-hover text-center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form action="process.php" method="POST">
                                        <input type="hidden" name="delete_customer" value="<?php echo $row['CustomerID']; ?>">
                                        <button class="btn btn-danger" onClick="return confirm('Are you sure to delete customer account?');" type="submit" name="delete_customer_btn">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        <?php
                                ...
                                echo '<p class="ml-3">'."No registered customer record is found.".'</p>';
                            }
