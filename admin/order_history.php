       ...
       <div id="layoutSidenav">
        ...
        <main>
            <div class="container-fluid">
                ...
                <h1 class="mt-4 mb-4 ml-1">Order History</h1>
                ...
                <div class="row table-responsive">
                    <table class="table table-hover text-center">
                        ...
                        <?php
                            ...
                            INNER JOIN Dispatch ON New_Order.NewOrderID = Dispatch.NewOrderID
                            WHERE New_Order.Status='Delivered'";
                        ...
                        ?>
                            ...
                            <?php
                                    ...
                                    echo '<p class="ml-3">'."No order history.".'</p>';
                                }
