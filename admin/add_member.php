       ...
       <div id="layoutSidenav">
        ...
        <main>
            <div class="container-fluid">
                ...
                <h1 class="mt-4 mb-4 ml-5">Add Member</h1>
                
                <form action="process.php" method="POST">
                    <div class="row">
                        <div class="mb-4 ml-5 col-md-4">
                            <label for="firstname">First Name *</label>
                            <div><input class="col-md-9 col-form-label" type="text" name="firstname" placeholder="Enter first name" pattern="[A-Za-z -]+" minlength="1" maxlength="50" required></div>
                        </div>
                        <div class="mb-4 ml-5 col-md-4"> 
                            <label for="lastname">Last Name *</label>
                            <div><input class="col-md-9 col-form-label" type="text" name="lastname" placeholder="Enter last name" pattern="[A-Za-z -]+" minlength="1" maxlength="50" required></div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="mb-4 ml-5 col-md-4">
                            ...
                            <div><input class="col-md-9 col-form-label" type="email" name="email" placeholder="Enter email" maxlength="100" required></div>
                        </div>
                        <div class="mb-4 ml-5 col-md-4">
                            <label for="contactnumber">Contact Number *</label>
                            <div><input class="col-md-9 col-form-label" type="tel" name="contactnumber" placeholder="Enter contact number" pattern="[0-9]+" minlength="10" maxlength="11" required></div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="mb-4 ml-5 col-md-4">
                            ...
                            <div><input class="col-md-9 col-form-label" type="password" name="password" placeholder="Enter password" minlength="8" maxlength="50" required></div>
                        </div>
                        <div class="mb-4 ml-5 col-md-4">
                    ...
                    <div class="row">
                        <div class="mt-5 ml-5 col-md-4">
                            ...
                            <input class="ml-3 btn btn-primary" type="submit" name="add_member_btn" value="Add Member">
                        </div> 
                    </div>
                </form>
