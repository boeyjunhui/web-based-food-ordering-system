        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="text-center">
                    <h1 class="mt-5"><b>Create New Password</b></h1>
                    <h5 class="mt-0 mb-5">Please enter your new password.</h5>
                </div>
                <?php
                ...
                ?>
                            ...
                            <div class="mb-5 form-group">
                                ...
                                <div><input class="form-control mb-3" type="password" name="pwd" placeholder="Enter a new password..." required></div>
                                <div><input class="form-control mt-2" type="password" name="pwd-repeat" placeholder="Repeat new password..." required></div>
                            </div>

                            <div>
                                <input class="col-md-12 btn btn-primary" type="submit" name="reset_password_submit_btn" value="Reset Password">
                            </div>
                            </div>
                            </div>
                            </form>
