  ...
  <div class="container-fluid-content">
    ...
    <div class="row">
      <?php
        ...
        $query = "SELECT * FROM Menu WHERE Category='Salads'";
      ...
      <div class="col-sm-3 col-md-4 col-lg-3 card">
        <?php echo '<img class="card-img-top" src=data:image;base64,'.$row['Image'].' alt="Menu Picture">'; ?>
          <div class="card-body">
            ...
            <p><?php echo $row['Description']."&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp"; ?></p>
            <form action="menu_salads.php" method="POST">
