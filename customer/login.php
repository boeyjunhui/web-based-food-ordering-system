        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="text-center">
                    <h1 class="mt-5"><b>Login to your account</b></h1>
                    <h5 class="mt-0 mb-5">New user? <a href="sign_up.php">Sign Up</a></h3>
                </div>

                <form action="login_logout_process.php" method="POST">
                    <div class="row">
                        ...
                        <div>
                            <input class="col-md-12 btn btn-primary mb-5" type="submit" name="login_btn" value="Login">
                        </div>
                        </div>
                    </div>
                </form>
