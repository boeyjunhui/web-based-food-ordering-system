            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <h1 class="mt-4 mb-4 ml-1">On Going Order</h1>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM Dispatch
                                        ...
                                        WHERE Dispatch.Status = 'Delivering' AND Dispatch.MemberID='$_SESSION[MemberID]'";
                                ...
                                <tr class="text-center" ">
                                    ...
                                    <td>
                                        <form action="rider_delivery_process.php" method="POST">
                                            <input type="hidden" name="duty_id" value="<?php echo $row['DutyID']; ?>">
                                            <input type="hidden" name="new_order_id" value="<?php echo $row['NewOrderID']; ?>">
                                            <button class="btn btn-primary" style="background-color:green" type="submit" name="delivered_btn">Delivered</button>
                                        </form>
                                    </td>
                                    <td>
